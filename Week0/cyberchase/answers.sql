-- 1. Write a SQL query to list the titles of all episodes Cyberchase’s original season, Season 1.
...
-- 6. List the titles of episodes from season 6 (2008) that were released early, 2007.
...
-- 8. Write a query that counts the number of episodes released the last 6 years, from 2018 to 2023, inclusive.
...
-- 9. Write a query that counts the number of episodes released Cyberchase’s first 6 years, from 2002 to 2007, inclusive.
...
-- 11. List the titles of episodes from season 5, reverse alphabetical order.
...
-- Write a SQL query to find the titles of episodes that have aired during the holiday season, usually December the United States.
